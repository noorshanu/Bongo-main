...
function Tokenomics() {
  return (
    <section className="container-wrapper bg-[#deedfe] rounded-2xl py-10 sm:py-14 px-4 sm:px-10 relative z-10">
     ...
     data-aos-easing="ease-in-sine">Catonomics</Title>
